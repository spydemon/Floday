\newglossaryentry{action}{
	...
	description={%
		...
		Elles peuvent être des exécutions de commandes, des écritures de configuration, ou de toutes autres formes prévues par la définition du \gls{conteneur} en cours d'\gls{instantiation}.
	}
}
...
\newglossaryentry{attribut}{
	...
	description={%
		...
		Il peut avoir des formes très variées, et se situent généralement au sein de la configuration d'un conteneur.
...
\newglossaryentry{gestionnaire}{
	...
	description={%
		Un \gls{conteneur} est gestionnaire s'il manage ou permet à d'autre conteneurs de fonctionner au travers de lui.
...
\newglossaryentry{runfile}{
	name=runfile,
	description={%
		Par défaut à l'emplacement {\tt/etc/runfile}, sont rôle est de définir explicitement toutes les \glspl{application} a exécuter sur l'ensemble du «\,parc\,» informatique géré.
