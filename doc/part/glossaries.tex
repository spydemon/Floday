...
\newglossaryentry{chemin_application}{
	...
	description={%
		Définis le nom concret d'une application en fonction de l'\gls{imbrication} de ses \glspl{gestionnaire}.
...
\newglossaryentry{chemin_conteneur}{
	...
	description={%
		Définis le type concret d'un conteneur en fonction de l'\gls{imbrication} de ses \glspl{gestionnaire}.
		Un tiret est utilisé pour séparer les différentes imbrications.
...
\newglossaryentry{runfile}{
	name=runfile,
	description={%
		Par défaut à l'emplacement {\tt/etc/runfile}, sont rôle est de définir explicitement toutes les \glspl{application} à exécuter sur l'ensemble du «\,parc\,» informatique géré.
