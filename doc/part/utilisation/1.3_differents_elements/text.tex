...
Avec un \gls{jeu_conteneur} à l'adresse par défaut, on peut par exemple trouver la \gls{definition} de notre premier conteneur à l'emplacement {\tt/etc/floday/containers/jaxe/children/web/children/wordpress/config.yml}.
...
\paragraph{Le nœud {\tt parameters}}
