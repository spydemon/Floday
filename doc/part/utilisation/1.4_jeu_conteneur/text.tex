...
Utiliser Perl pour les scripts peut néamoins être un choix à privilégier car le module \path{Floday::Setup} permet de facilement accéder à l'\gls{application} en cours de déploiement, à ses \glspl{param_applicatifs} ainsi qu'à quelques autres outils comme la génération de fichiers.
